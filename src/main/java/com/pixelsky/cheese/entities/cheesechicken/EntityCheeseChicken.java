...
public class EntityCheeseChicken extends EntityAnimal
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.world.isRemote && !this.isChild() && !this.isChickenJockey() && --this.timeUntilNextEgg <= 0)
        {
            ...
            this.dropItem(CheeseItems.CHEESE_BALL, 1);
            this.timeUntilNextEgg = this.rand.nextInt(6000) + 6000;
        }
    }
    ...
    public EntityCheeseChicken createChild(EntityAgeable ageable) {
        return new EntityCheeseChicken(this.world);
    }
    @Override
    ...
    {
        EntityLiving.registerFixesMob(fixer, net.minecraft.entity.passive.EntityChicken.class);
    }
    ...
    protected ResourceLocation getLootTable() {
        return LootTables.ENTITY_CHEESE_CHICKEN;
    }
    /**
